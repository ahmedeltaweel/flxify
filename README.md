...
A developer text utility tool with **119 executable scripts** accessible via a command palette. Available as a **web app**, **VS Code extension**, and **terminal CLI**. Paste text, run a script, get transformed output. Think "Swiss Army knife for text transformations."

**Try it:** [flxify.dev](https://flxify.dev) | **Install CLI:** `npm i -g @flxify/cli`

## Features

- **119 scripts** for JSON formatting, Base64 encoding, hashing, case conversion, sorting, and more
...
- **VS Code extension** with the same 119 scripts
...
Vim keybindings, command palette (Ctrl+B), 6 themes (Ctrl+T), and all 119 scripts. See [tui/README.md](tui/README.md) for full docs.
...
See [SCRIPTS.md](SCRIPTS.md) for a complete reference of all 119 scripts organized by category.
