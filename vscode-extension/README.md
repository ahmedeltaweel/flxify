...
> **119+ text transformation scripts for developers.** Format JSON, encode Base64, generate UUIDs, hash text, convert cases, sort lines, and more — without leaving your editor.
